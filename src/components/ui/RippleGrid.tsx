...
void main() {
    ...
    return () => {
      ...
      // Try/catch cleanup to avoid errors if context lost
      try {
  ...
  return <div ref={containerRef} className={className} style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }} />;
}
